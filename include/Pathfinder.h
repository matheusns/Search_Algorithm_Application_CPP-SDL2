...
public:
	...
	Path FindPath(NavigationNode* start, NavigationNode* end)
	{
		...
		{
			// Se a lista ABERTA estiver vazia, n�o pudemos encontrar um caminho.
			...
			// Pega o n� com menor FCost da lista ABERTA
